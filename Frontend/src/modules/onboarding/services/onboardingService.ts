...
export async function saveFarmerOnboarding(
  ...
  const dbPayload = {
    ...
    farm_details: {
      ...
      irrigatedLandUnit: payload.irrigatedLandUnit || "Acres",
      rainFedLandUnit: payload.rainFedLandUnit || "Acres",
...
export function mapFarmerDbToForm(db: any): FarmerOnboardingValues {
  ...
  return {
    ...
    irrigatedLandUnit: db.farm_details?.irrigatedLandUnit || "Acres",
    rainFedLandUnit: db.farm_details?.rainFedLandUnit || "Acres",
