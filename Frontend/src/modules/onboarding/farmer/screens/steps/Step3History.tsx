...
import { Input, SelectField, MultiSelectField } from '../../../../../design-system/components'; // 🚀 Added MultiSelectField
  ...
  return (
    <View>
      ...
      <Controller control={control} name="pastCrops" render={({ field }) => {
        const crops = field.value?.length > 0 ? field.value : [{ cropName: '', area: '', areaUnit: 'Acres', inputUsed: [], otherInputUsed: '', yield: '', yieldUnit: 'Quintals', problemsFaced: '' }]; // Default empty array
